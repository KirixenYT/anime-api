...
const disqus_iframe = (episodeId) =>
  `https://disqus.com/embed/comments/?base=default&f=kitsunime&t_u=http%3A%2F%2Fgogoanimez.free.nf%2F${episodeId}&s_o=default#version=cfefa856cbcd7efb87102e7242c9a829
`;
const disqus_api = (threadId, page) =>
  `https://disqus.com/api/3.0/threads/listPostsThreaded?limit=100&thread=${threadId}&forum=kitsunime&order=popular&cursor=${page}:0:0&api_key=E8Uh5l5fHZ6gD8U3KycjAIAk46f68Zw7C6eW8WSjZvCLXebZ7p0r1yrYDrLilk2F`;
